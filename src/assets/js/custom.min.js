$(document).ready(function () {
    ...
    $(function () {
        ...
        var i = function () {
            var i = 60, l = window.innerWidth > 0 ? window.innerWidth : this.screen.width,
        ...
        e(s).each(function () {
            var i = {toggle: !1}, l = e(this).closest(".panel"), s = l.find(".panel-wrapper"),
                n = e(this).children("i");
    ...
    }), $( "#publish-date-video" ).datepicker({"setDate": new Date(), "autoclose": true});
});